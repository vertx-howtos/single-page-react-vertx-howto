...
ifdef::env-github[]
image:https://travis-ci.com/NiccoMlt/single-page-react-vertx-howto.svg?branch=master["Build Status", link="https://travis-ci.com/NiccoMlt/single-page-react-vertx-howto"]
image:https://img.shields.io/badge/vert.x-3.8.3-purple.svg[link="https://vertx.io"]
image:https://img.shields.io/badge/code%20style-%E2%9D%A4-FF4081.svg["https://ktlint.github.io/"]

This application was partially generated using http://start.vertx.io
endif::env-github[]
...
[source,kotlin]
.Java `src/main/kotlin/io/vertx/howtos/react/BackendVerticle.kt`
----
include::src/main/kotlin/io/vertx/howtos/react/BackendVerticle.kt[tag=backend]
----
...
[source,kotlin]
.Kotlin `src/main/kotlin/io/vertx/howtos/react/BackendVerticle.kt`
----
include::src/main/kotlin/io/vertx/howtos/react/BackendVerticle.kt[tag=main]
----
...
[source,javascript]
.Javascript `src/main/frontend/src/index.jsx`
----
include::src/main/frontend/src/index.tsx[]
----
<1> The `Greeter` component is rendered in the web page inside `App` component

[source,javascript]
.Javascript `src/main/frontend/src/components/Greeter.jsx`
----
include::src/main/frontend/src/components/Greeter.tsx[]
----
...
<4> After initial rendering, an HTTP request is sent to the backend; the result is used to udpate the component state
...
Make sure all previous `npm` and `gradlew` executions are terminated and start the Vert.x server:
